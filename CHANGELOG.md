...
- 产品名：`Jev Couple`
- 产品说明：`懂你们：关系沟通辅助`
- 当前方向：在上游 Android 多平台聊天副驾能力上，收窄到情侣关系沟通、意图理解、冲突降低和人工确认回复。
- 上游项目：[jev-chat-jarvis](https://github.com/jev-chat/jev-chat-jarvis)
- 本项目与上游作者及原项目没有官方隶属、赞助或背书关系。
- 遵守 [LICENSE](LICENSE) 与 [NOTICE](NOTICE) 中的许可和署名要求。
